...
#'
#' @export
nbglm_mcmc_wls <- function(counts, design_mat, contrast_mat, prior_sd_betas, prior_sd_rs, prior_mean_log_rs, n_it, rw_sd_rs, log_offset, starting_betas, grain_size = 1L, burn_in_prop = .1, return_cont = FALSE, beta_names = NA_character_, cont_names = NA_character_) {
    .Call('_mcmseq_nbglm_mcmc_wls', PACKAGE = 'mcmseq', counts, design_mat, contrast_mat, prior_sd_betas, prior_sd_rs, prior_mean_log_rs, n_it, rw_sd_rs, log_offset, starting_betas, grain_size, burn_in_prop, return_cont, beta_names, cont_names)
}
