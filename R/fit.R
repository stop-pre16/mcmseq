...
mcmseq.fit <- function(counts=NULL, # matrix of RNA-Seq counts where rows are genes and columns are samples
                       ...
                       rw_sd_log_alpha = 3, #rw_sd_rs, # Random walk std. dev. for proposing dispersion values (normal distribution centerd at current value)
  ...
  # Issues with convergence paramters
